...
class TestObsIO():
    ...
    def full_obs(self):
        return obs_io.read_bufr_obs('./sample_data/bufr/2024052704.rap.t04z.prepbufr.csv',
                                    subset=[],
                                    domain=[])


    def test_read_bufr_obs_subset(self, full_obs):
        df = obs_io.read_bufr_obs('./sample_data/bufr/2024052704.rap.t04z.prepbufr.csv',
                                  subset=['ADPSFC'],
                                  domain=[])
